...
router.post('/api/getUserInfo', async (ctx, next) => {
  ...
  let wxData = await koa2Re({
    url: `https://api.weixin.qq.com/sns/jscode2session?appid=wx6193abb666921f6a&secret=a3362cad47c61c3afa5b3a40fc19a1ec&js_code=${query.code}&grant_type=authorization_code`,
  })
